...
module.exports = {
        initTextToSpeech : function(config,req,res) {
        ProcessTTS(config,req,res,processTTSResponse);
}
}

var ProcessTTS = function initTextToSpeech(config,req,res,next) {
    tokenManager.getToken(function (err, token) {
      if (err) {
        console.log('error:', err);
        console.log('Please refer to the https://github.com/KSrivastava.Sumit\n' +
...
var processTTSResponse = function(config,res,response){
